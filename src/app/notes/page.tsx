...
import { bmeNotes, beeNotes, mathsNotes } from '@/lib/data';
    ...
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-muted-foreground mt-2">
          A quick reference for key topics.
        </p>
      </header>
      ...
      <div className="space-y-8">
        <Card>
          <CardHeader>
            <CardTitle>Engineering Mathematics 1</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              {mathsNotes.map((note, index) => (
                <AccordionItem key={index} value={`math-item-${index}`}>
